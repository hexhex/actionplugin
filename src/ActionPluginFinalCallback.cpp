...
ActionPluginFinalCallback::ActionPluginFinalCallback(ActionPlugin::CtxData& ctxData,
...
#warning I ve to call the BestModelSelection function of the specified ActionAtom
  ...
  std::cerr << "\nControl if the order of Set in the List corresponds to their precedence"
      << std::endl;
  if (scheduler->checkIfTheListIsCorrect(multimapOfExecution, listOfExecution))
